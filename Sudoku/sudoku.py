def find_next_empty(puzzle):
    ...
    # return row, col tuple (or (Nonme None) if there is none)
...
def is_valid(puzzle, guess, row, col):
    # figures out whethere the guess at the row/col of the puzzle is a valid guess
    # returns True if it valid, False otherwise
...
def solve_sudoku(puzzle):
    ...
    # step 1: choose somwhere on the puzzle
    ...
    # step 2: if there is a place to put a number, then make a guess from 1 and 9
