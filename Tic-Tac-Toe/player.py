...
class GeniusComputerPlayer(Player):
    ...
    def get_move(self, game):
        if len(game.available_moves()) == 9:
            square = random.choice(game.available_moves()) # randomly chooses a move
        else:
    ...
    def minimax(self, state, player):
        ...
        other_player = 'O' if player == 'X' else 'X' # condensed if/else statement. Set to O if you're X, else set to X
